...
import africaMap from "../assets/logo-huge.png"; // Adjust the path to your actual image
...
const whyAfricaCards = [
  { text: "1B+ Population", style: "top-[20%] left-[15%]", color: "text-[#FF6B6B]" },
  { text: "Fastest Growing Economy", style: "bottom-[25%] right-[10%]", color: "text-[#00F5D4]" },
  { text: "Tech Innovation Hub", style: "top-[40%] right-[15%]", color: "text-[#FFE66D]" },
  { text: "Young Workforce", style: "bottom-[30%] left-[20%]", color: "text-[#FF6B6B]" },
  {}
];
